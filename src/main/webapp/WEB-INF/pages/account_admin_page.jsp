...
<body>
    <section class="accountsection">
        ...
        <div class="adminaccountdiv">
            ...
            <div class="buttonblock"><a href="/railway/account/trainpassenger"><button class="button3">Train passengers</button></a></div>
            <div class="buttonblock"><a href="/railway/account/viewalltrains"><button class="button3">View all trains</button></a></div>
        </div>
    </section>
